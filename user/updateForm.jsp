...
$(document).ready(function() {
   ...
   $("#btnUpdate").on("click", function() {
      ...
      $.ajax({
    	  ...
    	  {
    		xhr.setRequestHeader("AJAX", "true");		//헤더에 추가, 여기까지가 request 보내는 부분  
    	  },
        ...
        <div class="col-12">
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="userPwd2" name="userPwd2" value="${user.userPwd}" placeholder="비밀번호확인" maxlength="12" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="userEmail" name="userEmail" value="${user.userEmail}" placeholder="이메일" maxlength="30" />
                </div>
