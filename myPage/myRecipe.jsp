						                            ...
						                            <div class="container mt-5">
														    ...
														    <table class="table table-bordered">
														    	...
														    	<thead>
																 ...
																 <c:forEach var="myRecipeList" items="${myRecipeList}" varStatus="status"> 
															        <tbody>
															            <tr>
															            	<th scope="col"><img src="${myRecipeList.recipeImage}" width="100" height="100" /></th> 
															                <td scope="col" width="200" onclick="fn_view(${myRecipeList.recipeCode})"><u style="color:orange; cursor: pointer" >${myRecipeList.recipeName}</u></td>
															                <td scope="col">${myRecipeList.recipeIntro}</td>    <!-- tr태그는 가운데 정렬이되고 td태그는 왼쪽 정렬됨 -->
															            </tr>
															        </tbody>
															     </c:forEach>		
														    </table>
